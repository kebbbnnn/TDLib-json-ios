...
public final class TdApi {
    ...
    /// - Parameter settings: Settings for the authentication of the user's phone number
    ...
    public func confirmQrCodeAuthentication(
        link: String,
        completion: @escaping (Result<Session, Swift.Error>) -> Void) throws {
    ...
    public func setPassword(
        ...
        completion: @escaping (Result<PasswordState, Swift.Error>) -> Void) throws {
    ...
    public func getRecoveryEmailAddress(
        password: String,
        completion: @escaping (Result<RecoveryEmailAddress, Swift.Error>) -> Void) throws {
    ...
    public func createTemporaryPassword(
        password: String,
        validFor: Int,
        completion: @escaping (Result<TemporaryPasswordState, Swift.Error>) -> Void) throws {
    ...
    public func getUser(
        userId: Int,
        completion: @escaping (Result<User, Swift.Error>) -> Void) throws {
    ...
    public func getUserFullInfo(
        userId: Int,
        completion: @escaping (Result<UserFullInfo, Swift.Error>) -> Void) throws {
    ...
    public func getBasicGroup(
        basicGroupId: Int,
        completion: @escaping (Result<BasicGroup, Swift.Error>) -> Void) throws {
    ...
    public func getBasicGroupFullInfo(
        basicGroupId: Int,
        completion: @escaping (Result<BasicGroupFullInfo, Swift.Error>) -> Void) throws {
    ...
    public func getSupergroup(
        supergroupId: Int,
        completion: @escaping (Result<Supergroup, Swift.Error>) -> Void) throws {
    ...
    public func getSupergroupFullInfo(
        supergroupId: Int,
        completion: @escaping (Result<SupergroupFullInfo, Swift.Error>) -> Void) throws {
    ...
    public func getSecretChat(
        secretChatId: Int,
        completion: @escaping (Result<SecretChat, Swift.Error>) -> Void) throws {
    ...
    public func searchChatsNearby(
        location: Location,
        completion: @escaping (Result<ChatsNearby, Swift.Error>) -> Void) throws {
    ...
    public func checkChatUsername(
        chatId: Int64,
        username: String,
        completion: @escaping (Result<CheckChatUsernameResult, Swift.Error>) -> Void) throws {
    ...
    public func getChatMessageCount(
        ...
        filter: SearchMessagesFilter,
        returnLocal: Bool,
        completion: @escaping (Result<Count, Swift.Error>) -> Void) throws {
    ...
    /// - Parameter url: The message link in the format "https://t.me/c/...", or "tg://privatepost?...", or "https://t.me/username/...", or "tg://resolve?..."
    public func getMessageLinkInfo(
        url: String,
        completion: @escaping (Result<MessageLinkInfo, Swift.Error>) -> Void) throws {
    ...
    public func getTextEntities(
        text: String,
        completion: @escaping (Result<TextEntities, Swift.Error>) -> Void) throws {
    ...
    public func parseTextEntities(
        ...
        text: String,
        completion: @escaping (Result<FormattedText, Swift.Error>) -> Void) throws {
    ...
    public func getLanguagePackString(
        ...
        completion: @escaping (Result<LanguagePackStringValue, Swift.Error>) -> Void) throws {
    ...
    public func getJsonValue(
        json: String,
        completion: @escaping (Result<JsonValue, Swift.Error>) -> Void) throws {
    ...
    public func getInlineQueryResults(
        ...
        completion: @escaping (Result<InlineQueryResults, Swift.Error>) -> Void) throws {
    ...
    public func getCallbackQueryAnswer(
        ...
        completion: @escaping (Result<CallbackQueryAnswer, Swift.Error>) -> Void) throws {
    ...
    public func getGameHighScores(
        ...
        messageId: Int64,
        userId: Int,
        completion: @escaping (Result<GameHighScores, Swift.Error>) -> Void) throws {
    ...
    /// - Parameter chatId: Chat identifier
    /// - Parameter chatList: New chat list of the chat. The chat with the current user (Saved Messages) and the chat 777000 (Telegram) can't be moved to the Archive chat list
    public func setChatChatList(
        chatId: Int64,
        chatList: ChatList,
        completion: @escaping (Result<Ok, Swift.Error>) -> Void) throws {

        let query = SetChatChatList(
            chatId: chatId,
            chatList: chatList
        )
        execute(query: query, completion: completion)
    ...
    public func searchChatMembers(
        ...
        limit: Int,
        query: String,
        completion: @escaping (Result<ChatMembers, Swift.Error>) -> Void) throws {
    ...
    public func getChatAdministrators(
        chatId: Int64,
        completion: @escaping (Result<ChatAdministrators, Swift.Error>) -> Void) throws {
    ...
    public func getScopeNotificationSettings(
        scope: NotificationSettingsScope,
        completion: @escaping (Result<ScopeNotificationSettings, Swift.Error>) -> Void) throws {
    ...
    public func importContacts(
        contacts: [Contact],
        completion: @escaping (Result<ImportedContacts, Swift.Error>) -> Void) throws {
    ...
    public func getStickers(
        emoji: String,
        limit: Int,
        completion: @escaping (Result<Stickers, Swift.Error>) -> Void) throws {
    ...
    public func getStickerEmojis(
        sticker: InputFile,
        completion: @escaping (Result<Emojis, Swift.Error>) -> Void) throws {
    ...
    public func searchHashtags(
        limit: Int,
        prefix: String,
        completion: @escaping (Result<Hashtags, Swift.Error>) -> Void) throws {
    ...
    public func getWebPagePreview(
        text: FormattedText,
        completion: @escaping (Result<WebPage, Swift.Error>) -> Void) throws {
    ...
    public func getWebPageInstantView(
        forceFull: Bool,
        url: String,
        completion: @escaping (Result<WebPageInstantView, Swift.Error>) -> Void) throws {
    ...
    public func changePhoneNumber(
        phoneNumber: String,
        settings: PhoneNumberAuthenticationSettings,
        completion: @escaping (Result<AuthenticationCodeInfo, Swift.Error>) -> Void) throws {
    ...
    public func getChatEventLog(
        ...
        query: String,
        userIds: [Int],
        completion: @escaping (Result<ChatEvents, Swift.Error>) -> Void) throws {
    ...
    public func validateOrderInfo(
        ...
        messageId: Int64,
        orderInfo: OrderInfo,
        completion: @escaping (Result<ValidatedOrderInfo, Swift.Error>) -> Void) throws {
    ...
    public func getPaymentReceipt(
        chatId: Int64,
        messageId: Int64,
        completion: @escaping (Result<PaymentReceipt, Swift.Error>) -> Void) throws {
    ...
    public func searchBackground(
        name: String,
        completion: @escaping (Result<Background, Swift.Error>) -> Void) throws {
    ...
    /// - Parameter background: The input background to use, null for filled backgrounds
    /// - Parameter forDarkTheme: True, if the background is chosen for dark theme
    /// - Parameter type: Background type; null for default background. The method will return error 404 if type is null
    ...
    public func getLocalizationTargetInfo(
        onlyLocal: Bool,
        completion: @escaping (Result<LocalizationTargetInfo, Swift.Error>) -> Void) throws {
    ...
    public func getLanguagePackInfo(
        languagePackId: String,
        completion: @escaping (Result<LanguagePackInfo, Swift.Error>) -> Void) throws {
    ...
    public func getLanguagePackStrings(
        keys: [String],
        languagePackId: String,
        completion: @escaping (Result<LanguagePackStrings, Swift.Error>) -> Void) throws {
    ...
    public func registerDevice(
        ...
        otherUserIds: [Int],
        completion: @escaping (Result<PushReceiverId, Swift.Error>) -> Void) throws {
    ...
    public func getRecentlyVisitedTMeUrls(
        referrer: String,
        completion: @escaping (Result<TMeUrls, Swift.Error>) -> Void) throws {
    ...
    public func getUserPrivacySettingRules(
        setting: UserPrivacySetting,
        completion: @escaping (Result<UserPrivacySettingRules, Swift.Error>) -> Void) throws {
    ...
    public func getOption(
        name: String,
        completion: @escaping (Result<OptionValue, Swift.Error>) -> Void) throws {
    ...
    public func getChatStatisticsUrl(
        chatId: Int64,
        isDark: Bool,
        parameters: String,
        completion: @escaping (Result<HttpUrl, Swift.Error>) -> Void) throws {

        let query = GetChatStatisticsUrl(
            chatId: chatId,
            isDark: isDark,
            parameters: parameters
        )
    ...
    public func getChatStatistics(
        chatId: Int64,
        isDark: Bool,
        completion: @escaping (Result<ChatStatistics, Swift.Error>) -> Void) throws {
    ...
    /// - Parameter chatLimit: The maximum number of chats with the largest storage usage for which separate statistics should be returned. All other chats will be grouped in entries with chat_id == 0. If the chat info database is not used, the chat_limit is ignored and is always set to 0
    public func getStorageStatistics(
        chatLimit: Int,
        completion: @escaping (Result<StorageStatistics, Swift.Error>) -> Void) throws {
    ...
    public func getNetworkStatistics(
        onlyCurrent: Bool,
        completion: @escaping (Result<NetworkStatistics, Swift.Error>) -> Void) throws {
    ...
    /// - Parameter type: Type of the network for which the new settings are applied
    ...
    public func getBankCardInfo(
        ...
        completion: @escaping (Result<BankCardInfo, Swift.Error>) -> Void) throws {
    ...
    public func getPassportElement(
        ...
        completion: @escaping (Result<PassportElement, Swift.Error>) -> Void) throws {
    ...
    public func getAllPassportElements(
        password: String,
        completion: @escaping (Result<PassportElements, Swift.Error>) -> Void) throws {
    ...
    public func sendEmailAddressVerificationCode(
        emailAddress: String,
        completion: @escaping (Result<EmailAddressAuthenticationCodeInfo, Swift.Error>) -> Void) throws {
    ...
    public func getPassportAuthorizationForm(
        ...
        publicKey: String,
        scope: String,
        completion: @escaping (Result<PassportAuthorizationForm, Swift.Error>) -> Void) throws {
    ...
    public func getPassportAuthorizationFormAvailableElements(
        ...
        password: String,
        completion: @escaping (Result<PassportElementsWithErrors, Swift.Error>) -> Void) throws {
    ...
    /// - Parameter stickers: List of stickers to be added to the set; must be non-empty. All stickers must be of the same type
    ...
    public func sendCustomRequest(
        method: String,
        parameters: String,
        completion: @escaping (Result<CustomRequestResult, Swift.Error>) -> Void) throws {
    ...
    public func getInviteText(completion: @escaping (Result<Text, Swift.Error>) -> Void) throws {

        let query = GetInviteText()
        execute(query: query, completion: completion)
    }
    ...
    public func getDeepLinkInfo(
        link: String,
        completion: @escaping (Result<DeepLinkInfo, Swift.Error>) -> Void) throws {
    ...
    public func addProxy(
        ...
        server: String,
        type: ProxyType,
        completion: @escaping (Result<Proxy, Swift.Error>) -> Void) throws {
    ...
    public func pingProxy(
        proxyId: Int,
        completion: @escaping (Result<Seconds, Swift.Error>) -> Void) throws {
    ...
    public func getLogTagVerbosityLevel(
        tag: String,
        completion: @escaping (Result<LogVerbosityLevel, Swift.Error>) -> Void) throws {
    ...
    public func testCallString(
        x: String,
        completion: @escaping (Result<TestString, Swift.Error>) -> Void) throws {
    ...
    public func testCallBytes(
        x: Data,
        completion: @escaping (Result<TestBytes, Swift.Error>) -> Void) throws {
    ...
    public func testCallVectorInt(
        x: [Int],
        completion: @escaping (Result<TestVectorInt, Swift.Error>) -> Void) throws {
    ...
    public func testCallVectorIntObject(
        x: [TestInt],
        completion: @escaping (Result<TestVectorIntObject, Swift.Error>) -> Void) throws {
    ...
    public func testCallVectorString(
        x: [String],
        completion: @escaping (Result<TestVectorString, Swift.Error>) -> Void) throws {
    ...
    public func testCallVectorStringObject(
        x: [TestString],
        completion: @escaping (Result<TestVectorStringObject, Swift.Error>) -> Void) throws {
    ...
    public func testSquareInt(
        x: Int,
        completion: @escaping (Result<TestInt, Swift.Error>) -> Void) throws {
    ...
    public func testReturnError(
        error: Error,
        completion: @escaping (Result<Error, Swift.Error>) -> Void) throws {
