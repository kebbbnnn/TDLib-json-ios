...
public enum Update: Codable {
    ...
    case updateChatChatList(UpdateChatChatList)
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .updateChatChatList:
            let value = try UpdateChatChatList(from: decoder)
            self = .updateChatChatList(value)
        case .updateChatTitle:
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .updateNewChat(let value):
            ...
            try value.encode(to: encoder)
        case .updateChatChatList(let value):
            try container.encode(Kind.updateChatChatList, forKey: .type)
            try value.encode(to: encoder)
...
/// The list to which the chat belongs was changed. This update is guaranteed to be sent only when chat.order == 0 and the current or the new chat list is null
public struct UpdateChatChatList: Codable {
